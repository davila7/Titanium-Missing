...
@interface MissingV3Object : KrollCoverageObject {
#else
@interface MissingV3Object : KrollObject {
#endif
@private
...
extern NSString * MissingV3$ModuleRequireFormat;
