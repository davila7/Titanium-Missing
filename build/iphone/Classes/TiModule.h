...
/**
 The base class for all MissingV3 modules
 */
...
/**
 MissingV3 Platform calls this method on startup.
 */
-(void)startup;

/**
 MissingV3 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 MissingV3 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 MissingV3 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 MissingV3 Platform calls this method on resume.
 @param sender The sender of the event.
 */
