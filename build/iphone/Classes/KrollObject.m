...
//@interface MissingV3Object : NSObject
//@end

@interface MissingV3Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[MissingV3Object class]])
		{
			for (NSString *key in [[(MissingV3Object*)o modules] allKeys])
			{
