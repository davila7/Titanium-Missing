...
// in simulator we redefine to format for MissingV3 Developer console
...
{\
	NSString * exceptionName = [@"org.missingv3." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.missingv3";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIMissingV3NativeItemNone = -1, 
	UIMissingV3NativeItemSpinner = -2,
	UIMissingV3NativeItemProgressBar = -3,
	
	UIMissingV3NativeItemSlider = -4,
	UIMissingV3NativeItemSwitch = -5,
	UIMissingV3NativeItemMultiButton = -6,
	UIMissingV3NativeItemSegmented = -7,
	
	UIMissingV3NativeItemTextView = -8,
	UIMissingV3NativeItemTextField = -9,
	UIMissingV3NativeItemSearchBar = -10,
	
	UIMissingV3NativeItemPicker = -11,
	UIMissingV3NativeItemDatePicker = -12,
	
	UIMissingV3NativeItemInfoLight = -13,
	UIMissingV3NativeItemInfoDark = -14,
	
	UIMissingV3NativeItemDisclosure = -15,
	
	UIMissingV3NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all MissingV3 instances of
