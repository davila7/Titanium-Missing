...
/**
 Base class for all MissingV3 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the MissingV3 view hierarchy (such as wrapped iOS UIViews) was touched.
